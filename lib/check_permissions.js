...
function checkPermissions (args, cb) {
  ...
  function checkValidity(profile, validityCb) {
    ...
    function isRoleAllowed (done) {
      ...
      var userRoleDepth = getRoleDepth(permissions.roleHierarchy, getHighestPrivilegedRole(permissions.roleHierarchy, user.roles));
    ...
    function isUserTypeAllowed (done) {
      ...
      var userRoleDepth = getRoleDepth(permissions.userTypeHierarchy, getHighestPrivilegedRole(permissions.userTypeHierarchy, _.toArray(user.initUserType)));
